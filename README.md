...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-11-10 20:28`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/680b7ee5-effc-4b93-a961-c47d4e4f5435.git
$ cd 680b7ee5-effc-4b93-a961-c47d4e4f5435
```
